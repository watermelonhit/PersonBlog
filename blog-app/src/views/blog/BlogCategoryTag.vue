      ...
      <el-main>
        <div class="me-ct-title me-area">
          <template v-if="this.$route.params.type === 'tag'">
            <img class="me-ct-picture" :src="ct.avatar?ct.avatar:defaultAvatar" height="56px" width="56px"/>
    ...
    computed: {
      title() {
        if(this.$route.params.type === 'tag'){
          return `${this.ct.tagName} - 标签 - watermelonhit`
        }
        return `${this.ct.categoryName} - 文章分类 - watermelonhit`
      }
    },
    methods: {
